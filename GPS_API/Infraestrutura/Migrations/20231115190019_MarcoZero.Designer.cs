...
namespace Infraestrutura.Migrations
{
    ...
    [Migration("20231115190019_MarcoZero")]
    partial class MarcoZero
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Infraestrutura.DTOs.FolhaPagamentoDTO", b =>
                {
                    ...
                    b.Property<int>("IdRegistroDePonto")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Infraestrutura.DTOs.FolhaPagamentoDTO", b =>
                {
                    ...
                    b.HasOne("Infraestrutura.DTOs.RegistroPontoDTO", "RegistroPonto")
                        .WithMany("FolhaPagamento")
                        .HasForeignKey("IdRegistroDePonto")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
